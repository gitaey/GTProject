...
public class BotLogController {
    ...
    public ApiResponse<com.gtp.domain.bot.log.dto.BotLogStatsResponse> getDailyStats(
    ...
    public ApiResponse<com.gtp.domain.bot.log.dto.BotLogStatsResponse> getMonthlyStats(
