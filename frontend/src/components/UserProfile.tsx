    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md border">
            ...
            <div className="text-center mb-6">
                <div
                    className="w-16 h-16 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full mx-auto mb-3 flex items-center justify-center">
          <span className="text-2xl text-white font-bold">
            ...
            <div className="space-y-2 mb-4">
                ...
                <button onClick={toggleOnlineStatus}
                        className={`w-full px-4 py-2 rounded-lg ${user.isOnline ? 'bg-gray-500 hover:bg-gray-600' : 'bg-green-500 hover:bg-green-600'} text-white`}>
